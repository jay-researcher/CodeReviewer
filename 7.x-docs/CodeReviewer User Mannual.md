...
- 本机后续修订（尚未部署到 `192.168.3.78:8765`）增加 `No Review Required` 状态：当前 Cycle 经权威 Scope 对账确认没有可审核 MR 时，不生成空报告、不标记 Passed、不开放 Manual Pass，并从 Review Pass、Remaining 和待生成报告分母排除。
